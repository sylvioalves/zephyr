...
/**
 * @file
 * @brief Devicetree pin control helpers for Espressif ESP32C3
...
/**
 * @defgroup pinctrl_esp32c3 Espressif ESP32C3 pin control helpers
 * @brief Macros for pin control configuration of Espressif ESP32C3
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_ESPRESSIF_ESP32C3_PINCTRL_H_ */
