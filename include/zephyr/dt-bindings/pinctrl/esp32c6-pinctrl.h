...
/**
 * @file
 * @brief Devicetree pin control helpers for Espressif ESP32C6
...
/**
 * @defgroup pinctrl_esp32c6 Espressif ESP32C6 pin control helpers
 * @brief Macros for pin control configuration of Espressif ESP32C6
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PINCTRL_ESPRESSIF_ESP32C6_PINCTRL_H_ */
