...
#define RMT_DMA_INIT(idx)                                                                          \
	.dma_dev = COND_CODE_1(DT_INST_NODE_HAS_PROP(idx, dmas),                                   \
			       (DEVICE_DT_GET(DT_INST_DMAS_CTLR(idx))), (NULL)),                   \
	.tx_dma_channel = COND_CODE_1(DT_INST_DMAS_HAS_NAME(idx, tx),                              \
				      (DT_INST_DMAS_CELL_BY_NAME(idx, tx, channel)),               \
				      (RMT_DMA_CHANNEL_UNDEFINED)),                                \
	.rx_dma_channel = COND_CODE_1(DT_INST_DMAS_HAS_NAME(idx, rx),                              \
